...
(function () {
    ...
    function getUnitStats(team, type) {
        ...
        if (team === 'red') {
            if (type === 'zombie-runner') stats = { hp: 75, atk: 11, range: 1.6, speed: 5.1, atkCooldown: 0.75 };
            else if (type === 'zombie-brute') stats = { hp: 180, atk: 26, range: 1.9, speed: 2.6, atkCooldown: 1.25 };
            else if (type === 'zombie-spitter') stats = { hp: 85, atk: 13, range: 15, speed: 2.9, atkCooldown: 1.7 };
        }
    ...
    function createUnitMesh(u) {
        ...
        if (!isBlue) {
            ...
            else if (u.type === 'zombie-spitter') { c = 0x3f7a58; dc = 0x2b5a40; skinColor = 0x6ea776; }
        }
